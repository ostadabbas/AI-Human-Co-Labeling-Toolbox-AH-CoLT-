...
def train(epoch):
    ...
    '''
    # print(num_supine, num_prone, num_sitting, num_standing, num_allfours)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_pred',
                        ...
                        type=str, help='test preds')
    parser.add_argument('--train_anno',
                        default='/home/faye/Documents/InfantProject/data/SyRIP/test100_train600_2d/annotations/train600/person_keypoints_train_infant_529_5class.json',
                        type=str, help='train annotation')
    parser.add_argument('--test_anno',
    ...
    trainset = load_kpts_5class_gt(args.train_anno, transforms=None)
    ...
    #testset = load_kpts_5class_gt(args.test_anno, transforms = None)
