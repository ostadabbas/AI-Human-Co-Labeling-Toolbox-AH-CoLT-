...
import argparse
import numpy as np
from load_custom_dataset import load_data
from models import *
...
def test(epoch, dir_folder):
    ...
    if acc > best_acc:
        ...
        #     os.mkdir(arg.dir)
        torch.save(state, os.path.join(dir_folder,'rgb_ckpt.pth'))
        best_acc = acc
...
if __name__ == "__main__":
    ...
    #parser.add_argument('--train_imgs',
     #                   default='/home/faye/Documents/FiDIP_Posture/data/mimm/images/train_mimm/',
    #                    type=str, help='train set')
    #parser.add_argument('--test_imgs',
     #                   default='/home/faye/Documents/FiDIP_Posture/data/mimm/images/validate_mimm/',
    ...
    trainset = load_data(args.train_imgs, args.train_anno, transforms = transform)

    trainloader = torch.utils.data.DataLoader(
        trainset,  batch_size=train_batch_size, shuffle=True, num_workers=1)

    testset = load_data(args.test_imgs, args.test_anno, transforms = transform)
