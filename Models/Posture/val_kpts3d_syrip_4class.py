...
def test(epoch, dir_folder):
    ...
    with torch.no_grad():
        for batch_idx, (inputs, targets, imgs) in enumerate(testloader):
            ...
            # print(acces_list)
        print(metrics.confusion_matrix(tar_list[0].cpu(), pred_list[0].cpu()))
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Keypoints-based Posture Classifier Testing')
    ...
    #val_kpt = '/home/faye/Documents/FiDIP_Posture/Classifier/mimm_from_spin/output_gt_3D_val.npy'
    val_kpt = '/home/faye/Documents/FiDIP_Posture/Classifier/mimm_from_spin/output_pose_3D_val.npy'
    print(val_kpt)
    name_list_val = '/home/faye/Documents/FiDIP_Posture/Classifier/mimm_from_spin/output_imgnames_val.npy'
    print(name_list_val)
    '''
    ...
    checkpoint = torch.load('/home/faye/Documents/FiDIP_Posture/Classifier/train_syrip_pred_kpts3d_4class_output_202208290726/kpts_ckpt.pth')
    #checkpoint = torch.load('./kpts_output_202103030007/kpts_ckpt.pth')
    ...
    args.dir = 'kpts_output_test_' + nowTime
    os.mkdir(args.dir)
