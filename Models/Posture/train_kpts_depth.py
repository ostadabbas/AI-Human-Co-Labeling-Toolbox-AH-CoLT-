...
import argparse
import numpy as np
from load_custom_dataset import load_kpts_depth
from models import *
...
def test(epoch, dir_folder):
    ...
    if acc > best_acc:
        ...
        torch.save(state, os.path.join(dir_folder, 'kptsd_ckpt.pth'))
        best_acc = acc
...
if __name__ == "__main__":
    ...
    parser.add_argument('--depth_dir',
                        default='/home/faye/Documents/FiDIP_Posture/data/mimm/images/depth_data/',
                        type=str, help='depth data directory')
    ...
    trainset = load_kpts_depth(args.train_pred, args.train_anno, args.depth_dir, transforms = None)

    trainloader = torch.utils.data.DataLoader(
        trainset,  batch_size=train_batch_size, shuffle=True, num_workers=1)

    testset = load_kpts_depth(args.test_pred, args.test_anno, args.depth_dir, transforms = None)
    ...
    args.dir = 'kptsd_output_' + nowTime
    os.mkdir(args.dir)
