...
def box2cs(box, image_width, image_height):
    x, y, w, h = box[:4]
    return xywh2cs(x, y, w, h, image_width, image_height)


def xywh2cs(x, y, w, h, image_width, image_height):
